...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              <div className="space-y-6 text-center lg:text-left">
                <div>
                  <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-default-50 leading-tight">
                    Store your <span className="text-primary">files</span> with
                    ease
                  </h1>
                  <p className="text-lg md:text-xl text-default-50">
                    Simple.  Secure. Fast.
                  </p>
                </div>
              ...
              <div className="flex justify-center order-first lg:order-last">
                <div className="relative w-64 h-64 md:w-80 md:h-80">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <ImageIcon className="h-24 md:h-32 w-24 md:w-32 text-primary/90" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-12 md:py-16 px-4 md:px-6 ">
          <div className="container mx-auto">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-default-50">
                What You Get
              </h2>
            </div>
      ...
      {/* Simple footer */}
      <footer className="bg-default-900 border-t border-default-900 py-4 md:py-6">
