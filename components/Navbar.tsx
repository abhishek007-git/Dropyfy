...
export default function Navbar({ user }: NavbarProps) {
  ...
  return (
    <header
      className={`bg-slate-50/90  backdrop-blur-md border-b border-default-200 rounded-b-3xl sticky top-0 z-50 transition-shadow ${isScrolled ? "shadow-sm" : ""}`}
    >
      <div className="container mx-auto py-3 md:py-4 px-4 md:px-6">
        <div className="flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center gap-2 z-10">
            ...
            <h1 className="text-xl font-bold text-default-900">Dropyfy</h1>
          </Link>
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <Avatar
                          ...
                          fallback={<User className="h-4 w-4 text-default-900" />}
                        />
                        <span className="text-default-900 hidden sm:inline">
