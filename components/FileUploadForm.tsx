  ...
  return (
    <div className="space-y-4">
      ...
      <div
        ...
        className={`border-2 border-dashed rounded-lg p-6 text-center text-default-900 transition-colors ${
          error
      ...
      <div className="bg-default-100/5 p-4 rounded-lg">
        <h4 className="text-sm font-medium mb-2 text-default-700">Tips:</h4>
      ...
      >
        <ModalContent>
          <ModalHeader className="flex gap-2 items-center">
            ...
            <span className="text-default-600">New Folder</span>
          </ModalHeader>
          <ModalBody>
            <div className="space-y-4">
