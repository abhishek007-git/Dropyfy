    ...
    return (
      <Card className="max-w-md mx-auto border border-default-200 bg-default-50 shadow-sm hover:shadow-md transition-shadow">
        <CardHeader className="flex gap-3">
          ...
          <h2 className="text-xl font-semibold text-default-900">User Profile</h2>
        </CardHeader>
        <Divider />
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-default-500">Account Status</span>
            </div>
            <Badge
              color="success"
              variant="flat"
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-default-500">Email Verification</span>
            </div>
            <Badge
              color={
